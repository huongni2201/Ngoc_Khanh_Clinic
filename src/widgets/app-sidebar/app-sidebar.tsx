    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          href: "/patients",
          icon: Users,
          roles: ["ALL", "FRONT_DESK", "DOCTOR", "CLINIC_ADMIN"],
        },
        {
          label: "Lịch hẹn",
          href: "/appointments",
      ...
      items: [
        {
          ...
          href: "/laboratory",
          icon: FlaskConical,
          roles: ["ALL", "LAB_TECH", "CLINIC_ADMIN"],
        },
        {
          label: "Chẩn đoán hình ảnh",
          href: "/imaging",
          icon: Activity,
          roles: ["ALL", "IMAGING_TECH", "DOCTOR", "CLINIC_ADMIN"],
        },
      ],
    },
    {
